...
export default function HeroCertificacionIngles() {
  ...
  return (
    <section className="relative isolate overflow-visible">
      ...
      {/* 🔥 ESTE DIV CONTROLA EL TAMAÑO REAL */}
      <div className="relative isolate overflow-visible min-h-162.5 lg:min-h-190">
        ...
        {/* OVERLAY (BIEN OSCURO PARA QUE SE LEA) */}
        ...
        <div className="absolute bottom-0 left-0 w-full">
          <div className="mx-auto max-w-7xl px-4 sm:px-5 lg:px-6">
            <div className="flex justify-end">
              ...
              {/* 🔥 ESTO CONTROLA QUE TAN ABAJO ESTÁN */}
              <div className="grid w-full gap-4 sm:grid-cols-2 xl:grid-cols-4 lg:w-[80%] translate-y-[55%]">
